...
/**
 * Ninja Pal — in-world utility mod.
 * Registers a {@code /spawn} command that teleports the executing player to the overworld
 * (world) spawn point.
 *
 * <p>The AI companion ("a real player playing alongside you") is a separate program in the
 * {@code bot/} folder — a Mineflayer + LLM bot that logs into your world as a second player.
 * See {@code bot/README.md}.
 */
